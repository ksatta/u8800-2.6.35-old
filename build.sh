...
U8800_COMPILE_BY="ksatta" U8800_COMPILE_HOST="$datever" make ARCH=arm CROSS_COMPILE=/store/android/android-toolchain-eabi-linaro-4.6-2011.11-4-2011-11-15_12-22-49-linux-x86/android-toolchain-eabi/bin/arm-eabi- -j8
